...
public class XklaimCompilerTest {
	...
	@Test
	public void testProgramWithNodes() throws Exception {
		var input = """
				package foo
		...
		checkCompilation(input,
				Pair.of("foo.TestNode", """
						...
						"""),
				Pair.of("foo.TestNodeWithPhysicalLocality", """
						package foo;
	...
	@Test
	public void testProgramWithNet() throws Exception {
		var input = """
				package foo
	...
	@Test
	public void testXklaimOperations() throws Exception {
		checkCompilation("""
				package foo
				proc TestProcess(String s) {
					out(s, s)@self
	...
	@Test
	public void testXklaimNonBlockingOperationsInIfStatement() throws Exception {
		checkCompilation("""
				package foo
				proc TestProcess(String s) {
	...
	@Test
	public void testXklaimTimeoutOperationsInIfStatement() throws Exception {
		checkCompilation("""
				package foo
	...
	@Test
	public void testXklaimNonBlockingOperationsInComplexBooleanExpression() throws Exception {
		checkCompilation("""
				package foo
				proc TestProcess(String s) {
	...
	@Test
	public void testXklaimNonBlockingOperationsInWhileStatement() throws Exception {
		checkCompilation("""
				package foo
				proc TestProcess(String s) {
	...
	@Test
	public void testXklaimNonBlockingOperationsInForStatement() throws Exception {
		checkCompilation("""
				package foo
				proc TestProcess(String s) {
	...
	@Test
	public void testXklaimNonBlockingOperationsInDoWhileStatement() throws Exception {
		checkCompilation("""
				package foo
				proc TestProcess(String s) {
					do {
	...
	@Test
	public void testXklaimOperationsWithProcessCall() throws Exception {
		var input = """
				package foo
	...
	@Test
	public void testXklaimOperationsWithInlineProcess() throws Exception {
		var input = """
				package foo
	...
	@Test
	public void testXklaimInlineProcess() throws Exception {
		checkCompilation("""
				package foo
	...
	@Test
	public void testXklaimOperationsWithInlineProcessAccessingEnclosingScope() throws Exception {
		checkCompilation("""
				package foo
	...
	@Test
	public void testXklaimEval() throws Exception {
		var input = """
				package foo
	...
	private void checkCompilation(CharSequence input, CharSequence expectedGeneratedJava, boolean checkValidationErrors) throws Exception {
		compilationTestHelper.compile(input, result -> {
			if (checkValidationErrors) {
				assertNoValidationErrors(result);
			}
			if (expectedGeneratedJava != null) {
				assertGeneratedJavaCode(result, expectedGeneratedJava);
			}
			if (checkValidationErrors) {
	...
	@SafeVarargs
	private void checkCompilation(CharSequence input, Pair<CharSequence, CharSequence>... expectations) throws Exception {
		compilationTestHelper.compile(input, result -> {
			assertNoValidationErrors(result);
	...
	private void assertNoValidationErrors(CompilationTestHelper.Result it) {
	...
	private void assertGeneratedJavaCodeCompiles(CompilationTestHelper.Result r) {
		r.getCompiledClass(); // check Java compilation succeeds
	}
}
