...
public class Tuple implements Cloneable, java.io.Serializable {
    ...
    /**
     * Whether this tuple was removed from the tuple space because of an in
     * (this is used for blocking out)
     */
    ...
    public Tuple(Object... elems) {
        items = new Vector<Object>(elems.length);
    ...
    public void resetOriginalTemplate() throws TupleException {
    ...
    protected void restore_original_template() throws TupleException {
        Object elem;
        TupleItem my_elem;
    ...
    public void copy(Tuple t) throws TupleException {
        copy_elems(t);
     ...
     */
    public void copy_tuple(Tuple t) throws TupleException {
        copy_elems(t);
    ...
    protected void copy_elems(Tuple t) throws TupleException {
        Object elem;
        Object my_elem;
    ...
    /**
     * Tries to match the passed tuple with this tuple, if match
     * succeeds the passed tuple will be updated with the matching
     * values.
     * 
     * @param toBeMatched
     ...
     * @throws TupleException
     */
    public boolean match(Tuple toBeMatched) throws TupleException {
        ...
        for (int i = 0; i < length(); i++) {
            ...
            if (ItsElement instanceof Class
                ...
                if (itsElement.isFormal()) {
                    if (!MyElement.getClass().getName().equals(
    ...
    /**
     * @return Returns the removedFromTupleSpace.
     */
    ...
    /**
     * @param removedFromTupleSpace The removedFromTupleSpace to set.
     */
    public void setWasMatched(boolean removedFromTupleSpace) {
        this.wasMatched = removedFromTupleSpace;
    }
}
